...
#include "ui_rectificacion.h"

rectificacion::rectificacion(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::rectificacion)
{
    ui->setupUi(this);

    imagenIzquierda = imread("imagenes/imgIzquierda0.png");
    imagenDerecha = imread("imagenes/imgDerecha0.png");
    ...
    ui->rectIzq->setPixmap(QPixmap::fromImage(qimagenIzquierdaRect));
    ui->rectDer->setPixmap(QPixmap::fromImage(qimagenDerechaRect));
